...
Please open a [GitHub issue](https://github.com/learn-co-curriculum/phrg-js-basics-logging-lab/issues) or [pull-request](https://github.com/learn-co-curriculum/phrg-js-basics-logging-lab/pulls). Provide a detailed description that explains the issue you have found or the change you are proposing. Then "@" mention your instructor on the issue or pull-reqeust, and send them a link via Connect.
